...
var resizePizzas = function(size) {
  ...
  function determineDx (elem, size) {
    ...
    // Use document.getElementById in place of querySelector
  ...
  // Forced syncronous layout and determinedx usage to calculate currentWidth avoided by refactoring
  function changePizzaSizes(size) {
    ...
    //Take doucument.querySelector out of for loop
    // use document.getElementByClassName instead of queryselectorall
    var randomPizzas = document.getElementsByClassName("randomPizzaContainer");

    //store the length of randomPizzas.lenght in a variable
    var pizzaLength = randomPizzas.length;

    for (var i = 0; i < pizzaLength; i++) {
      randomPizzas[i].style.width = currentWidth + "%";
    }
  }
...
// To eliminate multiple DOM calls take out Var pizzasDiv outside the for loop
...
//To use requestAnimationFrame on updatePositions
window.addEventListener('scroll', animationCheck);
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
// Declaration of var elem moved out of the loop
  var elem;
//Declare movingPizzas outside the for loop to avoid multiple DOM calls
  var movingPizzas = document.getElementById('movingPizzas1');
  for (var i = 0; i < 36; i++) {
    elem = document.createElement('img');
    elem.className = 'mover';
    elem.src = "img/pizza.png";
    //make use of CSS for following code by pushing these to css file
    ...
    // To stop updatePositions from re-defining items on every scroll event
